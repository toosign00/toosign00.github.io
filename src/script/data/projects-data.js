...
export const projects = {
  ...
  'meme-repository': {
    ...
    technologies: [skills.html, skills.css, skills.javascript, skills.nodejs, skills.ejs, skills.mongodb],
    github: {
  ...
  'ora-gung': {
    ...
    technologies: [skills.html, skills.css, skills.javascript, skills.gsap, skills.jquery, skills.git],
