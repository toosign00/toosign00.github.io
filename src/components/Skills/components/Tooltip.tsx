				...
				{isVisible && (
					...
					>
						<div className="relative rounded-lg border border-white/10 bg-black/80 px-2 py-1 text-center shadow-xl backdrop-blur-md">
							<div className="text-xs font-medium whitespace-nowrap text-white">
								{content}
							</div>
							<div className="absolute -top-1 left-1/2 h-2 w-2 -translate-x-1/2 rotate-45 border-t border-l border-white/10 bg-black/80"></div>
						</div>
					</motion.div>
				)}
			</AnimatePresence>
